...
int globalCourse = 0;
bool print_hpposllh = true;
bool print_velned = true;
...
void ntrip_client_thread()
{
    const char *server = "dsdsds";
    const int port = dsdsds;
    const std::string mountpoint = "sdsds";
    const std::string username = "dsdsds";
    const std::string password = "sdsds";
